...
- '/c/<text>' which returns the string "C " followed by the value of `<text>`, with underscores replaced by spaces
...
def c_is_fun(text):
    ...
    Args:
        text (str): The text to be displayed after "C ". Underscores in the text are replaced by spaces.

    Returns:
        str: The string "C " followed by the value of <text> with underscores replaced by spaces.
    """
